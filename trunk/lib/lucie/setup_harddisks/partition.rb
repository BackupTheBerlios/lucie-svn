#
# $Id: partition.rb 967 2005-10-26 21:09:06Z sakae $
#
# Author::   Yoshiaki Sakae (mailto:sakae@is.titech.ac.jp)
# Revision:: $LastChangedRevision: 967 $
# License::  GPL2

require 'lucie/config/resource'
require 'lucie/setup_harddisks/const'
require 'lucie/setup_harddisks/ext2'
require 'lucie/setup_harddisks/ext3'
require 'lucie/setup_harddisks/reiserfs'
require 'lucie/setup_harddisks/xfs'
require 'lucie/setup_harddisks/swap'
require 'lucie/setup_harddisks/fat16'
require 'lucie/setup_harddisks/fat32'
